...
public class Player implements Serializable {
    ...
    private int points;  // the number of points this player has accrued
    ...
    public Player(Room currentRoom) {
        ...
        this.points = 0;  // initialized to 0
    }

    /**
        Adds points to the players point attribute
     * @param numPoints the number of points to be added
     */
    ...
    /**
        Removes points to the players point attribute
     * @param numPoints the number of points to be added
     */
