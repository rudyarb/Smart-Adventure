...
public class Room implements Serializable {
     ...
     */
    public ArrayList<Question> questionsInRoom = new ArrayList<>();

    public ArrayList<AdventureObject> objectsInRoom = new ArrayList<>();

    public Question currentQuestion;  // Used for accessing the question and its related answer in AdventureGameView class
    ...
    public String getObjectString() {
        ...
        for (AdventureObject object:
                this.objectsInRoom) {
            toReturn += object.getDescription() + ",";
        }
    ...
    public String getCommands() {
        ...
        for (Passage passage: this.motionTable.getDirection()) {
            if (!toCheck.contains(passage.getDirection().toUpperCase())) {  // If direction not in list, add
                toCheck.add(passage.getDirection().toUpperCase());
            }
            toCheck.add(passage.getDirection());
        }
    ...
    /**
     * Add a Question oobect to the questionInRoom arraylist so that it can be used when required
     *
     * @param question the Question object to be added
     * @return the room number attribute
     */
    public void addQuestion(Question question){
        this.questionsInRoom.add(question);
    }
    ...
    /**
     * Getter for returning an easy question
     *
